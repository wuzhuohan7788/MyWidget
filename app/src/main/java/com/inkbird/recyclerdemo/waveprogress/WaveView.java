...
public class WaveView extends LinearLayout {
    ...
    private int mAboveWaveStartColor;
    private int mAboveWaveEndColor;
    private int mBlowWaveStartColor;
    private int mBlowWaveEndColor;
    ...
    public WaveView(Context context, AttributeSet attrs) {
        ...
        mAboveWaveStartColor = attributes.getColor(R.styleable.WaveView_above_wave_start_color, DEFAULT_ABOVE_WAVE_COLOR);
        mAboveWaveEndColor = attributes.getColor(R.styleable.WaveView_above_wave_end_color, DEFAULT_ABOVE_WAVE_COLOR);
        mBlowWaveStartColor = attributes.getColor(R.styleable.WaveView_blow_wave_start_color, DEFAULT_BLOW_WAVE_COLOR);
        mBlowWaveEndColor = attributes.getColor(R.styleable.WaveView_blow_wave_end_color, DEFAULT_BLOW_WAVE_COLOR);
        ...
        mWave.setAboveWaveColor(mAboveWaveStartColor);
        mWave.setBlowWaveColor(mBlowWaveStartColor);
        ...
        mSolid.setAboveStartColor(mAboveWaveStartColor);
        mSolid.setAboveEndColor(mAboveWaveEndColor);
        mSolid.setBelowStartColor(mBlowWaveStartColor);
        mSolid.setBelowEndColor(mBlowWaveEndColor);
